...
{
    public const string Current = "2.6.32";
    public const string Name    = "AutoCo Avaluació";

    /// <summary>Descripció del canvi per al changelog intern.</summary>
    public const string ChangeLog = "v2.6.32: Fix nom creador real a ActivityDto (CreatedByProfessor nav. property); fix SQL patch EXEC() per columnes noves al mateix batch";
}
