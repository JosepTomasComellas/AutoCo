...
{
    public const string Current = "2.6.24";
    public const string Name    = "AutoCo Avaluació";

    /// <summary>Descripció del canvi per al changelog intern.</summary>
    public const string ChangeLog = "v2.6.24: Connexions actives — heartbeat Redis 10s/TTL 20s; pàgina /admin/connexions agrupada per rol i classe";
}
