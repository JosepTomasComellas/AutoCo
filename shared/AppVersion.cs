...
{
    public const string Current = "2.6.41";
    public const string Name    = "AutoCo Avaluació";

    /// <summary>Descripció del canvi per al changelog intern.</summary>
    public const string ChangeLog = "v2.6.41: Fix tabulat en copiar credencials del correu (CredentialBlock una sola td); v2.6.40: Participació doble Auto/Co";
}
