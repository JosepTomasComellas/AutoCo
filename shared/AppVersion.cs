...
{
    public const string Current = "2.6.38";
    public const string Name    = "AutoCo Avaluació";

    /// <summary>Descripció del canvi per al changelog intern.</summary>
    public const string ChangeLog = "v2.6.38: Participació doble a ActivityCard — barres separades Auto/Co; v2.6.37: Tancament sessió — docs CLAUDE.md i README actualitzats";
}
