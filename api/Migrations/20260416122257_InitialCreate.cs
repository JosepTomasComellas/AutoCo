        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumLlista = table.Column<int>(type: "int", nullable: false),
                    Nom = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Cognoms = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Email = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Modules_Professors_ProfessorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModuleExclusions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ModuleExclusions_Modules_ModuleId",
                        column: x => x.ModuleId,
                        principalTable: "Modules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ModuleExclusions_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Evaluations_Students_EvaluatedId",
                        column: x => x.EvaluatedId,
                        principalTable: "Students",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Evaluations_Students_EvaluatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CriteriaKey = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Evaluations_ActivityId_EvaluatorId_EvaluatedId",
                table: "Evaluations",
                columns: new[] { "ActivityId", "EvaluatorId", "EvaluatedId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EvaluationScores_EvaluationId_CriteriaKey",
                table: "EvaluationScores",
                columns: new[] { "EvaluationId", "CriteriaKey" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModuleExclusions_ModuleId_StudentId",
                table: "ModuleExclusions",
                columns: new[] { "ModuleId", "StudentId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ModuleExclusions_StudentId",
                table: "ModuleExclusions",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_Modules_ClassId_Code",
                table: "Modules",
                columns: new[] { "ClassId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Modules_ProfessorId",
                table: "Modules",
                column: "ProfessorId");
